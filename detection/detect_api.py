...
""" 
    - This is a document for detect_api.py in the detection module
    - Line 12 to line 33 that import necessary library and tools
    - Line 43 gets path to weight from yolov5
    - Function inference returns image path and detection result (coordinate 4 points, confident score, class_id)
...
def load_img(img0, img_size, stride, auto=True):    # Padded resize
